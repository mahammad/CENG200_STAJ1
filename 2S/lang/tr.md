# Sun Spoting
> Sun Spoting (2S) azerkosmos staj programı görevi.
...
4. [Kaynaklar](https://github.com/mahammad/CENG200_STAJ1/blob/master/2S/lang/az.md#Kaynaklar)

## Amacı

2S(Sun Spoting) iki aşamadan oluşmakta.

1. Güneş paneli sensörü ile azimut ve elevation yönlerinde sensör ürezindeki maksimum voltaj değerine görə güneş işıklarının maksimum düşme acısını kayıtedip ve bu maksimum bulma işlemi bittikten sonra güneş panelinin konumunu kayıt ettiği azimut ve elevation açılarına doğru yöneltmektir.
2. zamana göre güneşi takip etmek.

## Kullanılan Elemanlar

- Arduino UNO ![](/2S/img/unosxem.png)
- Solar Panel sensörü ![](/2S/img/sunpanel.png)
- 2 adet Servo motorla ![](/2S/img/servo.jpg)
- 2 adet 10k ohm direnç<br>
  ![](/2S/img/ohm.jpg)
- Bağlantı kabloları
...
/*
 * 1\. Solar Panel sensör vasitesile güneşden gelen işığın ölcerek en yüksek voltaja göre azimut ve elevation değerlerinin tapılması
...
//Solar sensörden verinin okunup işlenmesi
float readVoltage() {
...
---------------------------
 :arrow_up: [yukarı](https://github.com/mahammad/CENG200_STAJ1/blob/master/2S/lang/az.md#sun-spoting) | [Ana səhifə](https://github.com/mahammad/CENG200_STAJ1/blob/master/rm/az.md#azerkosmos-t%C9%99cr%C3%BCb%C9%99-program%C4%B1-tap%C5%9F%C4%B1r%C4%B1qlar%C4%B1)
 ----|----
